...
export default function SetPasswordClient() {
  ...
  useEffect(() => {
    setMounted(true)
    // Check if password setup is required (from URL parameter)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Force session update to clear needsPasswordSetup flag
          ...
          <Card className="relative backdrop-blur-3xl bg-white/96 dark:bg-slate-900/98 border-2 border-emerald-200/70 dark:border-emerald-500/40 shadow-2xl shadow-emerald-500/10 dark:shadow-emerald-400/30 rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                {isRequired && (
                  <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-500/30 rounded-xl p-4 mb-6">
