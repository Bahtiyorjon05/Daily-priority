...
export default function TaskCard({ 
  ...
  return (
    ...
    >
      <Card className={'relative overflow-hidden bg-white/95 dark:bg-gray-800/60 backdrop-blur-sm border border-slate-200 dark:border-gray-700 hover:border-emerald-300 dark:hover:border-emerald-600 shadow-sm hover:shadow-lg transition-all duration-300 ' + (task.status === 'COMPLETED' ? 'bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-700' : '') + ' ' + (priorityColor) + ' border-l-4 ' + (viewMode === 'grid' ? 'h-full' : '')}>
